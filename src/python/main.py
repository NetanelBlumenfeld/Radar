...
from config import DataCfg, DataTransformCfg, ExperimentCfg, PathsCfg, TrainCfg
...
if __name__ == "__main__":
    ...
    print(device)
    if (pc == "3080" or pc == "mac") and task == "sr_classifier":
    ...
    if pc == "4090" and task == "sr_classifier":
